...
void Game::LoadLevel(int level) {
    ...
    chopper.Tag("player");
    chopper.AddComponent<TransformComponent>(glm::vec2(120.0 * tileScale, 55.0 * tileScale), glm::vec2(1.0, 1.0), 0.0);
    ...
    tank.Group("enemies");
    tank.AddComponent<TransformComponent>(glm::vec2(250.0 * tileScale, 250.0 * tileScale), glm::vec2(1.0, 1.0), 0.0);
    ...
    truck.Group("enemies");
    truck.AddComponent<TransformComponent>(glm::vec2(60.0 * tileScale, 250.0 * tileScale), glm::vec2(1.0, 1.0), 0.0);
